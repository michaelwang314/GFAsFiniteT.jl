...
function run!()
    ...
    lj_particle_pair = [Particle(box ./ 2 .- [lj_r_cut / 4, 0.0, 0.0], γ, "lj particle"), Particle(box ./ 2 .+ [lj_r_cut / 4, 0.0, 0.0], γ, "lj particle")]
    ...
    m_particle_pair = [Particle(box ./ 2, γ, "morse particle"), Particle(box ./ 2, γ, "morse particle")]
    ...
    k = 20.0
    r0 = 0.5
    hb_particle_pair = [Particle(box ./ 2 .- [r0 / 2, 0.0, 0.0], γ, "harmonic particle"), Particle(box ./ 2 .+ [r0 / 2, 0.0, 0.0], γ, "harmonic particle")]
